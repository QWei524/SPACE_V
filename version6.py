...
class TopInfoBar(QFrame):
    def __init__(self, tz_name: str = "Pacific/Auckland", location_text: str = "Auckland, New Zealand"):
        ...
        self._tz, self._tz_label = _safe_get_tz(tz_name)
        ...
        self.lbl_tz = QLabel()
        self.lbl_tz.setStyleSheet("QLabel{font-size:13px;opacity:0.85}")

        self.lbl_loc = QLabel(self._location)
        self.lbl_loc.setStyleSheet("QLabel{font-size:13px;opacity:0.85}")
...
class InfoWidget(QWidget):
    def __init__(self, html_path: str = None, parent=None):
        ...
        self.browser.setStyleSheet(
            "QTextBrowser { background: rgba(255,255,255,0.05); color: #E6F0FF; border: none; }"
        )
...
class SkyGuideApp(QMainWindow):
    def __init__(self):
        ...
        self.stackedLayout.addWidget(self.main_page)   # 0
        self.stackedLayout.addWidget(self.login_page)  # 1
        self.stackedLayout.addWidget(self.signup_page) # 2
        self.stackedLayout.addWidget(self.home_page)   # 3
        ...
        self.info_bar = TopInfoBar("Pacific/Auckland", "Auckland, New Zealand")
        main_v.addWidget(self.info_bar)
...
class HomePage(QWidget):
    def __init__(self):
        ...
        self.top_bar = TopInfoBar("Pacific/Auckland", "Auckland, New Zealand")
        ...
        self.nasa.setUrl(QUrl("https://eyes.nasa.gov/apps/solar-system/#/home?featured=false&detailPanel=false&logo=false&search=false&shareButton=false&menu=false&collapseSettingsOptions=true&hideExternalLinks=true&surfaceMapTiling=true&hd=true&lighting=natural"))
