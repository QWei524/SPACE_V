...
class HomePage(QWidget):
    def __init__(self):
        ...
        # ✅ Correct QWebEngineView creation
        self.nasa = QWebEngineView(self.left_content)
        self.nasa.setPage(WebSitePage(self.nasa))
        ...
        # You can switch to NASA or Bilibili here ↓
        self.nasa.setUrl(QUrl("https://www.bilibili.com/"))
